...
export default function TeacherDetailClient({ params }: Props) {
  ...
  const imageSrc =
    teacher.branch === "qarshi"
      ? `/lehrer-qarshi/${teacher.slug}.${teacher.slug === "herr-khasan" || teacher.slug === "herr-lazizjon" ? "jpg" : "JPG"}`
