...
export default function SaisonarbeitClient() {
  const { locale, t } = useI18n();
  const dict = dictionaries[locale].afzalliklar.saisonarbeit as {
    reqItems: string[];
      ...
      <div className="container py-12">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-8">
            {t("afzalliklar.saisonarbeit.title")}
          </h1>
          <div className="w-24 h-1 bg-accent mx-auto mb-8" />
          <p className="text-lg text-foreground/70 max-w-3xl mx-auto">
            {t("afzalliklar.saisonarbeit.subtitle")}
          </p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6 rounded-2xl border border-border/60 bg-white/80 dark:bg-secondary/5">
            ...
            <p className="text-foreground/80 leading-relaxed">
              {t("afzalliklar.saisonarbeit.whatDesc")}
            </p>
          </Card>
          <Card className="p-6 rounded-2xl border border-border/60 bg-white/80 dark:bg-secondary/5">
            <h3 className="text-xl font-semibold mb-3 flex items-center gap-2">
